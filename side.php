...
function go(s) {
 if (document.f.t.value) { window.open ("http://" + s + document.f.t.value,
"_content", "location=yes,scrollbars=yes,resizable=yes"); }
 else { alert("Merci d'entrer une URL dans la case ci-dessus"); }
}
function gw(s) {
 if (document.f.t.value) { window.open ("http://" + s + dom(), "_content",
...
function gs(s) {
 if (!document.f.t.value) { alert("Merci d'entrer une URL dans la case ci-dessus"); }
  ...
  var domain = dom();
  window.open ("http://" + s + domain + " " + document.f.q.value,
"_content", "location=yes,scrollbars=yes,resizable=yes");
 }
}
function gt(tool) {
...
function go_google(s) {
   if (document.f.t.value) {
     ...
     window.open ("http://" + s + domaine, "_content",
"location=yes,scrollbars=yes,resizable=yes");
   }
   else { alert("Merci d'entrer une URL dans la case ci-dessus");  }
 }
